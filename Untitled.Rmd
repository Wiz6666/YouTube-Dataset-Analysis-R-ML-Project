...
author: "Wiz ZHANG(SID:23210735)； Xiao ZHANG(SID:)"
...
```
  ...
  Skewness analysis is crucial as it helps in understanding the symmetry of the data distribution [@Joanes & Gill1998]. 
  We observe a higher percentage of right-skewed columns in our dataset, which implies...
...
```
  ...
  We use head command to keep analyzing data.
