...
logNull <- logLikelihood(youtube_train[,target_column], sum(youtube_train[,target_column]==pos)/nrow(youtube_train))
cat(logNull)
```
#### 4.3.2.1 The likelihood of categorical variables
```{r}
...
```
#### 4.3.2.2 The likelihood of numeric variables
```{r warning=FALSE}
selNumVars <- c()
minDrop <- 10 # 可能还需要调整值的大小
