...
=======
clustering_data <- raw_data 
>>>>>>> c0e2398b447965685b20842c1fe82dd9ea387c06
```
...
### 4.6.1 Build Logistic Regression for all features
```{r}
lrmodel1 <- glm(as.formula(paste("binary_class ~ ", paste(c(categorical_independent_variables, numeric_independent_variables), collapse = ' + '))), data = train_data, family = "binomial")
```

```{r warning=FALSE}
selVars <- c("channel_type_status","category","subscribers","video_views","uploads","created_year","subs_engagement","uploads_frequency","average_views_per_video","urban_rate","age","edu_ratio","top_channel_flag","video_views_increasing_rate","channel_age_adjusted_income","country_status" )
